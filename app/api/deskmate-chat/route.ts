...
function buildSystemPrompt(characterId: string, ctx?: UserContext): string {
  ...
  return `${persona}\n\nYou're talking to this Love Pic student right now — ${facts.join('; ')}. Weave in a detail from this naturally when it fits instead of listing facts back at them, and don't overdo it every single message.`
}
